...
```shell
docker build . -t quay.io/labs-backstage/backstage:latest --no-cache
docker login quay.io/labs-backstage/backstage
docker push quay.io/labs-backstage/backstage:latest
```

note the images is already pushed to `ghcr.io/labs-backstage/backstage-app-demo:main`
